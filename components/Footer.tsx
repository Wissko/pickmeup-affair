...
export default function Footer() {
  return (
    <footer
      className="page-content section-over-bg py-12 md:py-16"
      style={{ borderTop: '1px solid rgba(201,146,90,0.15)' }}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          >
            © 2025 The Tiramisu Affair. All rights reserved. · Sauce Bistro, 50 Frasers Road, Ashgrove, Brisbane
          </p>
        </div>
      </div>
    </footer>
